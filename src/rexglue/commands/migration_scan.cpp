...
constexpr std::array<BreakingChangeRule, 47> kRules = {{
    {"REX_HOOK", "REX_HOOK", ""},
    {"REX_STUB", "REX_STUB", ""},
    {"REX_STUB_LOG", "REX_STUB_LOG", ""},
    {"REX_STUB_RETURN", "REX_STUB_RETURN", ""},
    {"REX_FUNC", "REX_FUNC", ""},
    {"REX_WEAK_FUNC", "REX_WEAK_FUNC", ""},
    {"REX_EXTERN", "REX_EXTERN", "REX_EXTERN was extern \"C\" REX_FUNC; use REX_EXTERN"},
    {"REX_EXTERN", "REX_EXTERN",
     "REX_EXTERN was extern \"C\" REX_FUNC; use REX_EXTERN"},
    {"PPC_EXTERN_FUNC", "", "removed; declare with extern REX_FUNC(name)"},
    {"REX_JOIN", "REX_JOIN", ""},
    {"REX_XSTRINGIFY", "REX_XSTRINGIFY", ""},
    {"REX_STRINGIFY", "REX_STRINGIFY", ""},
    {"rex::ppc::kRoundNearest", "rex::ppc::kRoundNearest", ""},
    {"rex::ppc::kRoundTowardZero", "rex::ppc::kRoundTowardZero", ""},
    {"rex::ppc::kRoundUp", "rex::ppc::kRoundUp", ""},
    {"rex::ppc::kRoundDown", "rex::ppc::kRoundDown", ""},
    {"rex::ppc::kRoundMask", "rex::ppc::kRoundMask", ""},
    {"REX_CONFIG_NON_ARGUMENT_AS_LOCAL", "REX_CONFIG_NON_ARGUMENT_AS_LOCAL", ""},
    {"REX_CONFIG_NON_VOLATILE_AS_LOCAL", "REX_CONFIG_NON_VOLATILE_AS_LOCAL", ""},
    {"REX_CONFIG_SKIP_LR", "REX_CONFIG_SKIP_LR", ""},
    {"REX_CONFIG_CTR_AS_LOCAL", "REX_CONFIG_CTR_AS_LOCAL", ""},
    {"REX_CONFIG_XER_AS_LOCAL", "REX_CONFIG_XER_AS_LOCAL", ""},
    {"REX_CONFIG_RESERVED_AS_LOCAL", "REX_CONFIG_RESERVED_AS_LOCAL", ""},
    {"REX_CONFIG_SKIP_MSR", "REX_CONFIG_SKIP_MSR", ""},
    {"REX_CONFIG_CR_AS_LOCAL", "REX_CONFIG_CR_AS_LOCAL", ""},
    {"REX_FUNC_PROLOGUE", "REX_FUNC_PROLOGUE", ""},
    {"REX_CALL_FUNC", "REX_CALL_FUNC", ""},
    {"REX_LOOKUP_FUNC", "REX_LOOKUP_FUNC", ""},
    {"REX_CALL_INDIRECT_FUNC", "REX_CALL_INDIRECT_FUNC", ""},
    {"REX_SET_FLUSH_MODE", "REX_SET_FLUSH_MODE", ""},
    {"REX_UNIMPLEMENTED", "REX_UNIMPLEMENTED", ""},
    {"REX_QUERY_TIMEBASE", "REX_QUERY_TIMEBASE", ""},
    {"REX_CHECK_GLOBAL_LOCK", "REX_CHECK_GLOBAL_LOCK", ""},
    {"REX_ENTER_GLOBAL_LOCK", "REX_ENTER_GLOBAL_LOCK", ""},
    {"REX_LEAVE_GLOBAL_LOCK", "REX_LEAVE_GLOBAL_LOCK", ""},
    {"REX_PHYS_HOST_OFFSET", "REX_PHYS_HOST_OFFSET", ""},
    {"REX_RAW_ADDR", "REX_RAW_ADDR", ""},
    {"REX_LOAD_U8", "REX_LOAD_U8", ""},
    {"REX_LOAD_U16", "REX_LOAD_U16", ""},
    {"REX_LOAD_U32", "REX_LOAD_U32", ""},
    {"REX_LOAD_U64", "REX_LOAD_U64", ""},
    {"REX_LOAD_STRING", "REX_LOAD_STRING", ""},
    {"REX_STORE_U8", "REX_STORE_U8", ""},
    {"REX_STORE_U16", "REX_STORE_U16", ""},
    {"REX_STORE_U32", "REX_STORE_U32", ""},
    {"REX_STORE_U64", "REX_STORE_U64", ""},
    {"REX_MEMORY_SIZE", "REX_MEMORY_SIZE", ""},
}};
